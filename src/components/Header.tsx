                        ...
                        >
                          ...
                          <div className="p-2 border-b border-brand-border">
                            ...
                            <button 
                              ...
                              className={cn(
                                "w-full flex items-center gap-3 p-3 rounded-xl hover:bg-brand-hover transition-colors group text-left",
                                activeTab === 'gestao' ? "text-brand-primary bg-brand-hover/50" : "text-brand-text-dim hover:text-brand-text"
                              )}
                            >
                              <LayoutGrid className={cn("w-4 h-4", activeTab === 'gestao' ? "text-brand-primary" : "group-hover:text-brand-primary")} />
                              <span className="text-sm font-bold">Central de Gestão</span>
                            </button>
                          </div>
